      ...
      <div className={`${Modules.mainAboutUs}`}>
        <Container className={`${Modules.containerAboutUs}`}>
          ...
          <Row>
            ...
            <Col>
              <img
                src={this.state.image.Section6.Img2}
                alt="dummy"
            ...
            <Col>
              <img
                src={this.state.image.Section6.Img3}
                alt="dummy"
            ...
            <Row className={`${Modules.sectionSeven}`}>
              ...
              >
                <img
                  ...
                  src={this.state.image.Section7.Img1}
                  alt="Founder"
                ></img>
              ...
              >
                <img
                  className={`${Modules.sevenImage}`}
                  src={this.state.image.Section7.Img2}
                  alt="CEO"
                ></img>
              ...
              >
                <img
                  className={`${Modules.sevenImage}`}
                  src={this.state.image.Section7.Img3}
                  alt="Roots1"
                ></img>
              ...
              >
                <img
                  className={`${Modules.sevenImage}`}
                  src={this.state.image.Section7.Img4}
                  alt="Roots2"
                ></img>
              ...
              <Row className={`${Modules.innerRow}`}>
                <Col className={`${Modules.row1Col1} col-md-4`}>
                  <img
                    ...
                    src={this.state.image.Section7b.Img1}
                    alt="Founder"
                  ></img>
                </Col>
            ...
            >
              <Row className={`${Modules.innerRow}`}>
                ...
                <Col className={`${Modules.row2Col2} col-md-4`}>
                  <img
                    className={`${Modules.image7}`}
                    src={this.state.image.Section7b.Img2}
                    alt="Ceo"
                  ></img>
                </Col>
              </Row>
            ...
            >
              <Row className={`${Modules.innerRow}`}>
                <Col className={`${Modules.row3Col1} col-md-4`}>
                  <img
                    className={`${Modules.image7}`}
                    src={this.state.image.Section7b.Img3}
                    alt="Roots1"
                  ></img>
                </Col>
            ...
            >
              <Row className={`${Modules.innerRow}`}>
                ...
                <Col className={`${Modules.row4Col2} col-md-4`}>
                  <img
                    className={`${Modules.image7}`}
                    src={this.state.image.Section7b.Img4}
                    alt="Roots2"
                  ></img>
                </Col>
              </Row>
